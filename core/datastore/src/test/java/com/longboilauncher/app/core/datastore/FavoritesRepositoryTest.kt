...
class FavoritesRepositoryTest {
    ...
    @Test
    fun `favorites flow is initially empty`() = runTest {
    ...
    @Test
    fun `addFavorite adds app to list`() = runTest {
    ...
    @Test
    fun `removeFavorite removes app by id`() = runTest {
        repository.addFavorite(testApp)
    ...
    @Test
    fun `reorderFavorites updates positions`() = runTest {
    ...
    @Test
    fun `hideApp adds package to hidden list`() = runTest {
    ...
    @Test
    fun `unhideApp removes package from hidden list`() = runTest {
        repository.hideApp("com.hidden.app")

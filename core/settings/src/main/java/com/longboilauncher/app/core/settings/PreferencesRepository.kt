...
class PreferencesRepository
    ...
    constructor(
        ...
        val gestureSwipeUp: Flow<String> =
            dataStore.data
                .catch { exception ->
                    if (exception is IOException) {
                        emit(UserSettings.getDefaultInstance())
                ...
                }.map { it.gestureSwipeUp.ifBlank { "all_apps" } }

        val gestureSwipeDown: Flow<String> =
            dataStore.data
                .catch { exception ->
                    if (exception is IOException) {
                        emit(UserSettings.getDefaultInstance())
        ...
        val iconPackPackageName: Flow<String> =
            dataStore.data
                .catch { exception ->
                    if (exception is IOException) {
                        emit(UserSettings.getDefaultInstance())
        ...
        val perAppIconOverrides: Flow<Map<String, String>> =
            dataStore.data
                .catch { exception ->
                    if (exception is IOException) {
                        emit(UserSettings.getDefaultInstance())
